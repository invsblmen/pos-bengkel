  ...
  return (
    <section className="space-y-5">
      <Card
        ...
        footer={<p className="text-sm text-slate-500 dark:text-slate-400">Buat service order baru dengan customer, kendaraan, mekanik, dan item opsional.</p>}
      >
        <div className="flex flex-col gap-4 lg:flex-row lg:items-center lg:justify-between">
          <div className="space-y-2">
            <p className="text-sm text-slate-600 dark:text-slate-300">Gunakan form ini untuk transaksi workshop yang baru.</p>
            <p className="text-xs text-slate-500 dark:text-slate-400">Submission token dibuat otomatis untuk mencegah duplikasi.</p>
          </div>
